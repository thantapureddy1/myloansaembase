 ...
 */
package com.myloans.aembase.core.models;
...
import com.myloans.aembase.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "myloansaembase/components/helloworld");
